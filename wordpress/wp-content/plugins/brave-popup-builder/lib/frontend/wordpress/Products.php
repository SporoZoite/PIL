               ...
               $postHTML .= '<div class="brave_product__chunk '.$slideClass. $hasBackgroundClass. $buttonAlwaysClass.'">';
                     foreach ($block as $theproduct) {
                        ...
                        $postHTML .=  '<div id="brave_product-'.$productID.'" class="brave_product">';
                           ...
                           if($variableProduct){
                              $cartButton = '<a href="'.get_the_permalink($productID).'" '.$goalAction.' data-quantity="1" data-product_id="'.$productID.'" data-product_sku="'.$productSKU.'" rel="nofollow">'.$buttonTextVar.'</a>';
                           }
                           ...
                           $postHTML .=  '<div class="brave_product__content_wrap">';
                              ...
                              if($displayCat){
                                 ...
                                 $postPrice = $theproduct->is_on_sale() ? $salePrice : $regularPrice;
